...
export default function PrivacyPolicyContent() {
    return (
        <div className="space-y-6 text-slate-600 leading-relaxed">
            <section>
                <h2 className="text-[#1a1d21] font-semibold text-lg mb-2">1. Recolección de Información</h2>
            ...
            <section>
                <h2 className="text-[#1a1d21] font-semibold text-lg mb-2">2. Uso de los Datos</h2>
            ...
            <section>
                <h2 className="text-[#1a1d21] font-semibold text-lg mb-2">3. Protección de la Información</h2>
            ...
            <section>
                <h2 className="text-[#1a1d21] font-semibold text-lg mb-2">4. Tus Derechos</h2>
            ...
            <section className="pt-4 border-t border-[#e4e6e9] text-sm italic">
