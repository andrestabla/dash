...
function AnalyticsView({ tasks, settings, statuses }: { tasks: Task[], settings: BoardSettings, statuses: StatusColumn[] }) {
    // Mirror the public board's "Datos" view exactly so the private and public
    // data views are visually identical (same cards, layout and styling).
    return (
        <div className="view-section active animate-fade-in space-y-8" style={{ padding: '20px', maxWidth: 1800, margin: '0 auto', width: '100%' }}>
